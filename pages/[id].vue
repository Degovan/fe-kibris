        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <img src="/bg.jpg" class="img-thumbnail w-100" alt="...">
                </div>
                <div class="col-lg-6 col-sm-12">
                    <h3>{{ id }}</h3>
                    ...
                    <p>
                        Apakah Anda mencari gambar tentang Gambar Bunga Mawar Buat Kekasih? Terdapat 53 Koleksi Gambar berkaitan dengan Gambar Bunga Mawar Buat Kekasih, File yang di unggah terdiri dari berbagai macam ukuran dan cocok digunakan untuk Desktop PC, Tablet, Ipad, Iphone, Android dan Lainnya. Silahkan lihat koleksi gambar lainnya dibawah ini untuk menemukan gambar yang sesuai dengan kebutuhan anda.
                    </p>
                    <div class="mt-3">
